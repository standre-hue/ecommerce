...
if (isset($_POST['form1'])) {
    ...
    if(empty($_POST['cust_phone'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer un numero de telephone valide"."<br>";
    }

    if(empty($_POST['cust_address'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer une address valide"."<br>";
    }

    if(empty($_POST['cust_country'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer un pays valide"."<br>";
    }

    if(empty($_POST['cust_city'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer une ville valide"."<br>";
    }

    if(empty($_POST['cust_state'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer un etat valide"."<br>";
    }

    if(empty($_POST['cust_zip'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer un code zip valide"."<br>";
    }
    ...
    if($valid == 1) {
        ...
        $success_message = "Informations modifiees avec succes";
            ...
            <div class="col-md-12">
                <div class="user-content">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="submit" class="btn btn-primary" value="Enregistrer" name="form1">
                    </form>
                </div>                
            </div>
        </div>
