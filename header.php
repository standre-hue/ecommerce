...
$statement->execute(array('En Cours'));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
foreach ($result as $row) {
...
<div class="header">
	<div class="container">
		<div class="row inner">
			...
			<div class="col-md-5 right" style="margin-left:auto; ">
				<ul>
					
					<?php
					if(isset($_SESSION['customer'])) {
						?>
						<li><i class="fa fa-user"></i> Connecte en tant que <?php echo $_SESSION['customer']['cust_name']; ?></li>
						<li><a href="dashboard.php"><i class="fa fa-home"></i> <?php echo LANG_VALUE_89; ?></a></li>
						<?php
					} else {
						?>
						<li><a href="login.php"><i class="fa fa-sign-in"></i> Se Connecter</a></li>
						<li><a href="registration.php"><i class="fa fa-user-plus"></i> S'inscrire</a></li>
						<?php	
					}
					?>

					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i> Mon Panier (<?php
			...
			<div class="col-md-3 search-area"  style="margin-left:auto;">
				<form class="navbar-form navbar-left" role="search" action="search-result.php" method="get">
					<?php $csrf->echoInputField(); ?>
					<div class="form-group">
						<input type="text" class="form-control search-top" placeholder="Rechercher un produit" name="search_text">
					</div>
