...
if(isset($_POST['form1'])) {
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Categorie mise a jour avec success.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier Categorie de fin</h1>
	</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Categorie Top Nom <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="tcat_id" class="form-control select2 top-cat">
                            <option value="">Selectionner Categorie Top Nom</option>
                            <?php
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Categorie du Milieu Nom <span>*</span></label>
                    <div class="col-sm-4">
                        <select name="mcat_id" class="form-control select2 mid-cat">
                            <option value="">Selectionner Categorie du Milieu Nom</option>
                            <?php
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">Categorie de fin Nom <span>*</span></label>
                    <div class="col-sm-4">
