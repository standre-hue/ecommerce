            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
								...
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											...
											<h4 class="modal-title" style="font-weight: bold;">Envoyer un Message</h4>
										</div>
                        ...
                        <td>
                            ...
                            <br><br>
                            <?php
                                if($row['payment_status']=='En Cours'){
                                    ?>
                                    <a href="order-change-status.php?id=<?php echo $row['id']; ?>&task=completee" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Completer</a>
                                    <?php
                                }
                            ?>
                        </td>
                        <td>
                            ...
                            <br><br>
                            <?php
                            if($row['payment_status']=='completee') {
                                if($row['shipping_status']=='En Cours'){
                                    ?>
                                    <a href="shipping-change-status.php?id=<?php echo $row['id']; ?>&task=completee" class="btn btn-warning btn-xs" style="width:100%;margin-bottom:4px;">Completer</a>
                                    <?php
                                }
                            }
                            ?>
