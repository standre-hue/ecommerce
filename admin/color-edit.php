...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['color_name'])) {
        $valid = 0;
        $error_message .= "Veuillez remplire le champs<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'La couleur existe deja <br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Coleur enregistree avec succes.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier Couleur</h1>
	</div>
	<div class="content-header-right">
		<a href="color.php" class="btn btn-primary btn-sm">Voire tous</a>
	</div>
</section>
