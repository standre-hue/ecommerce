...
<section class="content-header">
	<div class="content-header-left">
		<h1>Categorie de fin</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category-add.php" class="btn btn-primary btn-sm">Ajouter</a>
	</div>
</section>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-striped">
			<thead>
			    <tr>
			        <th>ID</th>
			        <th>Categorie Fin Nom</th>
                    <th>Categorie du Milieu Nom</th>
                    <th>Categorie Top Nom</th>
			        <th>Action</th>
			    </tr>
			</thead>
            <tbody>
