...
if(!isset($_SESSION['user']) or $_SESSION['user']['role'] != 'Super Admin' ) {
						...
						<li class="dropdown user user-menu">
							...
							<ul class="dropdown-menu">
								<li class="user-footer">
									<div>
										<a href="profile-edit.php" class="btn btn-default btn-flat">Modifier son profile</a>
									</div>
									<div>
      			...
      			<ul class="sidebar-menu">
                    ...
                    <li class="treeview <?php if( ($cur_page == 'size.php') || ($cur_page == 'size-add.php') || ($cur_page == 'size-edit.php') || ($cur_page == 'color.php') || ($cur_page == 'color-add.php') || ($cur_page == 'color-edit.php') || ($cur_page == 'country.php') || ($cur_page == 'country-add.php') || ($cur_page == 'country-edit.php') || ($cur_page == 'shipping-cost.php') || ($cur_page == 'shipping-cost-edit.php') || ($cur_page == 'top-category.php') || ($cur_page == 'top-category-add.php') || ($cur_page == 'top-category-edit.php') || ($cur_page == 'mid-category.php') || ($cur_page == 'mid-category-add.php') || ($cur_page == 'mid-category-edit.php') || ($cur_page == 'end-category.php') || ($cur_page == 'end-category-add.php') || ($cur_page == 'end-category-edit.php') ) {echo 'active';} ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="shipping-cost.php"><i class="fa fa-circle-o"></i> Cout d'expedition</a></li>
                            <li><a href="top-category.php"><i class="fa fa-circle-o"></i> Categorie du Top </a></li>
                            <li><a href="mid-category.php"><i class="fa fa-circle-o"></i> Categorie du milieu</a></li>
                            <li><a href="end-category.php"><i class="fa fa-circle-o"></i> Categorie de fin</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'product.php') || ($cur_page == 'product-add.php') || ($cur_page == 'product-edit.php') ) {echo 'active';} ?>">
                        <a href="product.php">
                            <i class="fa fa-hand-o-right"></i> <span>gestion Produits</span>
                        </a>
                    </li>
                    ...
                    <li class="treeview <?php if( ($cur_page == 'order.php') ) {echo 'active';} ?>">
                        <a href="order.php">
                            <i class="fa fa-hand-o-right"></i> <span>Gestion Commandes</span>
                        </a>
                    </li>
					...
					<li class="treeview <?php if (($cur_page == 'customer.php') || ($cur_page == 'customer-add.php') || ($cur_page == 'customer-edit.php')) {
						...
						<a href="customer.php">
							<i class="fa fa-hand-o-right"></i> <span>Client</span>
						</a>
					</li>
