...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Veuiillez choisir une categorie du milieu <br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Veuiillez choisir une categorie du fin<br>";
    }

    if(empty($_POST['p_name'])) {
        $valid = 0;
        $error_message .= "Veuillez remplire le nom du produit<br>";
    }

    if(empty($_POST['p_current_price'])) {
        $valid = 0;
        $error_message .= "Veuillez entrer un prix valide<br>";
    }

    if(empty($_POST['p_qty'])) {
        $valid = 0;
        $error_message .= "La quantite ne peut pas etre null ou 0<br>";
    }
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Vous devez choisir une image<br>';
        }
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Produit modifie avec succes.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Nom de Categorie superieure <span>*</span></label>
							<div class="col-sm-4">
								<select name="tcat_id" class="form-control select2 top-cat">
		                            <option value="">Selectionner une  Categorie superieure</option>
		                            <?php
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
		                            <option value="">Selectioner une Categorie Du Milieu</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Categorie de fin <span>*</span></label>
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
		                            <option value="">Selectionner une  Categorie de fin</option>
		                            <?php
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Couleur</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Photo Principal</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Changer  la Photo Principal </label>
							<div class="col-sm-4" style="padding-top:4px;">
								<input type="file" name="p_featured_photo">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">D'autre Photos</label>
							<div class="col-sm-4" style="padding-top:4px;">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Qualites</label>
							<div class="col-sm-8">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Polique de retournement</label>
							<div class="col-sm-8">
								<textarea name="p_return_policy" class="form-control" cols="30" rows="10" id="editor5"><?php echo $p_return_policy; ?></textarea>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">est Recent?</label>
							<div class="col-sm-8">
								<select name="p_is_featured" class="form-control" style="width:auto;">
									<option value="0" <?php if($p_is_featured == '0'){echo 'selected';} ?>>Non</option>
									<option value="1" <?php if($p_is_featured == '1'){echo 'selected';} ?>>Oui</option>
								</select> 
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Est Actif?</label>
							<div class="col-sm-8">
								<select name="p_is_active" class="form-control" style="width:auto;">
									<option value="0" <?php if($p_is_active == '0'){echo 'selected';} ?>>Non</option>
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<button type="submit" class="btn btn-success pull-left" name="form1">Mettre a jour</button>
							</div>
						</div>
					</div>
				</div>
