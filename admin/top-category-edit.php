...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Le champs ne peut pas etre vide<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'La cetegorie existe deja<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'La categorie a ete mise a jour.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier categorie du Top</h1>
	</div>
	<div class="content-header-right">
		<a href="top-category.php" class="btn btn-primary btn-sm">Voire Tous</a>
	</div>
</section>
