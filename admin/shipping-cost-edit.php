...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['country_id'])) {
        $valid = 0;
        $error_message .= "Vous devez selectionner un pays<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Le Pays existe deja<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Cout d expedition enregistre avec succes.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier Cout d'expedition</h1>
	</div>
	<div class="content-header-right">
		<a href="shipping-cost.php" class="btn btn-primary btn-sm">Voire tous</a>
	</div>
</section>
