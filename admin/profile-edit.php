...
if(isset($_POST['form1'])) {
	...
	if($_SESSION['user']['role'] == 'Super Admin') {
	    ...
	    if(empty($_POST['email'])) {
	        $valid = 0;
	        $error_message .= ' l\'Address Email ne peut pas etre vide<br>';
	    } else {
	    	if (filter_var($_POST['email'], FILTER_VALIDATE_EMAIL) === false) {
		        $valid = 0;
		        $error_message .= 'l\'Address Email doit etre  valide<br>';
		    } else {
		    	...
		    	if($total) {
		    		$valid = 0;
		        	$error_message .= 'Address email deja existant<br>';
		    	}
		    }
	    }
	    ...
	    if($valid == 1) {
	    	...
	    	$success_message = 'Information mise a jour.';
	    }
	}
	else {
...
if(isset($_POST['form2'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Vous devez choisir une photo de profile<br>';
        }
    }
...
if(isset($_POST['form3'])) {
    ...
    if( !empty($_POST['password']) && !empty($_POST['re_password']) ) {
    	if($_POST['password'] != $_POST['re_password']) {
	    	$valid = 0;
	        $error_message .= "Les mots de pass ne correspondent pas<br>";	
    	}        
    }
    ...
    if($valid == 1) {
		...
		$statement->execute(array($_POST['password'],$_SESSION['user']['id']));

    	$success_message = 'Mot de pass mise a jour.';
    }
}
?>
		...
		<div class="col-md-12">
				...
				<div class="nav-tabs-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_2" data-toggle="tab">Modifier la Photo</a></li>
						<li><a href="#tab_3" data-toggle="tab">Modifier le Mot de pass</a></li>
					</ul>
					<div class="tab-content">
          				<div class="tab-pane active" id="tab_1">
							...
							<div class="box box-info">
								<div class="box-body">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label"> Address Email<span>*</span></label>
										<?php
										if($_SESSION['user']['role'] == 'Super Admin') {
											?>
												<div class="col-sm-4">
									...
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Numero de Telephone </label>
										<div class="col-sm-4">
							...
							<div class="box box-info">
								<div class="box-body">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form2">Enregistrer</button>
										</div>
									</div>
								</div>
							</div>
          				...
          				<div class="tab-pane" id="tab_3">
							...
							<div class="box box-info">
								<div class="box-body">
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Mot de pass </label>
										<div class="col-sm-4">
											<input type="password" class="form-control" name="password">
										</div>
									</div>
									<div class="form-group">
										<label for="" class="col-sm-2 control-label">Confirmer mot de pass </label>
										<div class="col-sm-4">
							        ...
							        <div class="form-group">
										<label for="" class="col-sm-2 control-label"></label>
										<div class="col-sm-6">
											<button type="submit" class="btn btn-success pull-left" name="form3">Enregistrer</button>
										</div>
									</div>
								</div>
							</div>
