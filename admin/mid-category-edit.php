...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Vous devez selectionner une categorie superieur<br>";
    }

    if(empty($_POST['mcat_name'])) {
        $valid = 0;
        $error_message .= "Le nom de la category ne doit pas etre vide<br>";
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Category enregister avec succes.';
    }
}
?>
...
<section class="content-header">
	<div class="content-header-left">
		<h1>Modifier categorie du milieu</h1>
	</div>
	<div class="content-header-right">
		<a href="mid-category.php" class="btn btn-primary btn-sm">Voire tous</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <button type="submit" class="btn btn-success pull-left" name="form1">Enregister</button>
                    </div>
                </div>
