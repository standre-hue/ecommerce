...
if(isset($_POST['form1'])) {
    ...
    if($path!='') {
        ...
        if( $ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif' ) {
            $valid = 0;
            $error_message .= 'Vous devez selectionner une photo<br>';
        }
    } else {
    	$valid = 0;
        $error_message .= 'Vous devez selectionner une photo<br>';
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Produit enregistre avec succes.';
    }
}
?>
...
<section class="content-header">
	...
	<div class="content-header-right">
		<a href="product.php" class="btn btn-primary btn-sm">Voire tous</a>
	</div>
</section>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Categorie Superieur <span>*</span></label>
							<div class="col-sm-4">
								<select name="tcat_id" class="form-control select2 top-cat">
									<option value="">Categorie Superieur</option>
									<?php
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="mcat_id" class="form-control select2 mid-cat">
									<option value="">Selectionne Categorie Intermediaire</option>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
									<option value="">Categorie de fin</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Ancien Prix <br><span style="font-size:10px;font-weight:normal;"></span></label>
							<div class="col-sm-4">
								<input type="text" name="p_old_price" class="form-control">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label"> Prix Acuel <span>*</span><br><span style="font-size:10px;font-weight:normal;"></span></label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Coleur</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Politique de retournement</label>
							<div class="col-sm-8">
