...
if(isset($_POST['form1'])) {
    ...
    for($i=1;$i<=count($arr1);$i++) {
        ...
        if($table_quantity[$temp_index] < $arr2[$i]) {
        	$allow_update = 0;
            $error_message .= '"'.$arr2[$i].'" element indisponible "'.$arr3[$i].'"\n';
        } else {
	...
	<?php else: ?>
		<script>alert('Toutes les mise a jour de quantite ont ete effectue!');</script>
	<?php endif; ?>
    <?php
...
?>
    ...
    <div class="page-banner-inner" style="display:flex; align-items: center; justify-content:center";>
        <h1>Mon Panier</h1>
    </div>
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="cart-buttons">
                    <ul>
                        <li><input type="submit" value="Mettre a jour monpanier" class="btn btn-primary" name="form1"></li>
                        <li><a href="index.php" class="btn btn-primary">Continuer mes courses</a></li>
                        <li><a href="checkout.php" class="btn btn-primary">Proceder au paiement</a></li>
                    </ul>
                </div>
                </form>
                <?php endif; ?>
...
<?php if (isset($_GET['paid'])): ?>
    <script>
        alert('Payement effectue avec succes, Vous pouvez le consulter sur votre tablleau de bord dans la section commande')
    </script>
<?php endif; ?>
            </div>
        </div>
